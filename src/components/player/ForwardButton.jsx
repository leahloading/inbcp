// this function is really just some svg code that has been pasted in along with attributes: aria-hidden and spread props (we end up passing in the height and width, stroke and on hover classes)
// e.g. you can copy and paste svg code from a website like this : [Heroicons](https://heroicons.com/), add some classes and you are good to go
...
export function ForwardButton({ player, amount = 10 }) {
  return (
    ...
    >
      ...
      {/* these props will be spread onto the svg element */}
